...
import com.example.urbanhop.graphics.backdrops.rememberCombinedBackdrop
...
import com.example.urbanhop.graphics.shadow.InnerShadow
import com.example.urbanhop.graphics.shadow.Shadow
import com.example.urbanhop.utils.DampedDragAnimation
import com.example.urbanhop.utils.InteractiveHighlight
    ...
    BoxWithConstraints(
        ...
        Row(
            Modifier
                ...
                .drawBackdrop(
                    backdrop = backdrop,
                    shape = { RoundedCornerShape(32.dp) //any shape
                    },
                    effects = {
                        vibrancy()
                        blur(8f.dp.toPx())
